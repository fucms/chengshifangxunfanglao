    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="信息编号">
          <el-input v-model="listQuery.filter1" placeholder="请输入信息编号" />
        </el-form-item>
        <el-form-item label="积水地址">
          <el-input v-model="listQuery.filter2" placeholder="请输入积水地址" />
        </el-form-item>
        <el-form-item>
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column label="信息编号" prop="code" align="center">
