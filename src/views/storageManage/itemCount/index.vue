  ...
  <div class="warning-broadcast">
    <el-row :gutter="20" type="flex" justify="flex-start">
      ...
      <el-col :span="24">
        <el-card>
          <strong>公告发布</strong>
          <el-button type="primary" style="margin-left: 20px;" @click="showPublishDialog">点击发布</el-button>
          <el-dialog
            title="快速发布"
          ...
          >
            <el-form ref="publishForm" :model="publishForm" label-width="120px">
              ...
              <el-form-item label="发布渠道" :rules="{ required: true, message: '请选择发布渠道', trigger: 'change' }">
                <el-select v-model="publishForm.units" placeholder="请选择发布渠道">
      ...
      <el-col :span="24">
        <el-card>
          ...
          <el-table :data="floodData" style="width: 100%" border>
            ...
            <el-table-column prop="units" label="发布渠道" width="100" />
...
export default {
  data() {
    return {
      ...
      // 防汛防涝信息的初始数据
      floodData: [
        { title: '城区东部高危预警', units: '微信', content: '预计未来2小时将有暴雨，请密切关注水位变化。' },
        { title: '城区南部中危预警', units: '微信', content: '水位上升较快，请做好排涝准备。' },
        { title: '城区东部高危预警', units: '微信', content: '预计未来2小时将有暴雨，请密切关注水位变化。' },
        { title: '城区南部中危预警', units: '微信', content: '水位上升较快，请做好排涝准备。' }
      ],
