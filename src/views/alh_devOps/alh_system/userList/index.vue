        ...
        <div class="filter-container">
            ...
            <el-form :inline="true" :model="listQuery" class="demo-form-inline">
                <el-form-item label="姓名/工号">
                    <el-input v-model="listQuery.filter" placeholder="请输入姓名/工号"></el-input>
                </el-form-item>
                <el-form-item label="部门">
                    <el-input v-model="listQuery.filter" placeholder="请输入部门"></el-input>
                </el-form-item>
                <el-form-item label="员工组">
                    <el-select v-model="listQuery.filter" placeholder="请选择员工组">
